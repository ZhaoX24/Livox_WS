...
public:
    ...
    ParamServer() {
        ...
        nh.param<std::string>("lio_sam/gpsTopic", gpsTopic, "fix");
        ...
        nh.param<bool>("lio_sam/debugLidarTimestamp", debugLidarTimestamp, false);
        nh.param<bool>("lio_sam/debugImu", debugImu, false);
        nh.param<bool>("lio_sam/debugGps", debugGps, false);
        ...
        nh.param<int>("lio_sam/imuFrequence", imuFrequence, 500);
        ...
        if (sensor == SensorType::HESAI) {
            nh.param<vector<double >>("lio_sam/imuAccBias_N", imuAccBias_NV, vector<double>());
            nh.param<vector<double >>("lio_sam/imuGyrBias_N", imuGyrBias_NV, vector<double>());
            nh.param<vector<double >>("lio_sam/imuGravity_N", imuGravity_NV, vector<double>());
        ...
        nh.param<float>("lio_sam/surroundingkeyframeAddingDistThreshold", surroundingkeyframeAddingDistThreshold,
                        1.0);
        ...
        nh.param<float>("lio_sam/globalMapLeafSize", globalMapLeafSize, 1.0);
